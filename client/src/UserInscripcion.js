...
function UserInscripcion(props) {
                  ...
                  <Row>
                    <Col xs sm md lg xl={8}>
                      <Card.Title className="nunito">
                        <strong>Formaciones y eventos disponibles:</strong>
                      </Card.Title>
                      <p>
                        ¿Quieres inscribirte a alguno? Introduce el código
                        completo y tu nombre para poder realizar el registro.
                      </p>
